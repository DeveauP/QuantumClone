...
The full package is available and is maintained on: [CRAN](http://cran.r-project.org/web/packages/QuantumClone/index.html), you can chose to source the GUI but it may affect computation.
